  ...
  return (
    <section className="bg-ivory">
      <Container className="py-8 text-center md:py-14 lg:py-7">
        ...
        <h2 className="mx-auto mt-3 max-w-[36rem] font-serif text-[1.85rem] leading-[1.12] font-medium tracking-tight text-ink uppercase sm:text-[2.15rem] lg:mt-2 lg:text-[2.82rem]">
          {content.heading}
        </h2>
