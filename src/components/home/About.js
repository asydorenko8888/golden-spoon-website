      ...
      <Container className="relative z-[1] pt-4 pb-7 md:py-12 lg:flex lg:h-full lg:min-h-0 lg:items-center lg:py-8">
        <div className="lg:grid lg:h-full lg:min-h-0 lg:w-full lg:grid-cols-2 lg:items-center lg:gap-x-[84px] xl:gap-x-[100px]">
          <div className="relative max-w-[34rem]">
            ...
            <h2 className="mt-2 font-serif text-[2.15rem] leading-[1.05] font-medium tracking-tight text-ink sm:text-[2.45rem] lg:text-[2.75rem]">
            ...
            <div className="mt-4 space-y-3 text-[0.95rem] leading-7 text-ink md:mt-5 md:space-y-4 lg:text-[15px] lg:leading-[1.7]">
          ...
          <figure className="relative mt-5 md:mt-8 lg:mt-0 lg:h-full">
            ...
            >
              ...
              />
              <p className="pointer-events-none absolute top-5 right-5 max-w-[11rem] text-right font-script text-[1.45rem] leading-[1.15] text-gold sm:top-7 sm:right-7 sm:text-[1.65rem] lg:text-[clamp(22px,1.8vw,30px)]">
