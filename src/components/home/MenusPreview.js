    ...
    <section className="relative overflow-hidden bg-ivory lg:scroll-mt-[var(--header-height)]">
      ...
      <Container className="relative z-[1] pt-4 pb-5 md:py-9 lg:pt-2 lg:pb-8">
        <div className="mx-auto max-w-[40rem] text-center">
          ...
          <h2 className="mt-1.5 font-serif text-[1.7rem] leading-[1.12] font-medium tracking-tight text-ink sm:text-[2rem] lg:text-[2.58rem]">
            {content.heading}
          </h2>
          <p className="mx-auto mt-3 max-w-[34rem] text-[0.85rem] leading-6 text-ink lg:mt-2.5 lg:text-[16.8px] lg:leading-[1.55]">
            {content.copy}
          </p>
        </div>
