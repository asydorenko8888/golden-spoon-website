    ...
    <section className="relative overflow-hidden bg-ivory lg:h-[calc((100vh-var(--header-height))*0.72)] lg:max-h-[calc((100vh-var(--header-height))*0.72)]">
      ...
      <Container className="relative z-[1] flex min-h-[16.5rem] items-center py-8 sm:min-h-[20rem] md:py-14 lg:box-border lg:h-full lg:min-h-0 lg:items-start lg:pt-[4.75rem] lg:pb-8">
        <div className="max-w-[28rem]">
          ...
          <h1 className="mt-2.5 font-serif text-[2.15rem] leading-[1.02] font-medium tracking-[-0.01em] text-ink uppercase sm:text-[2.45rem] lg:text-[clamp(36px,3.1vw,48px)] lg:leading-[1.02]">
          ...
          <p className="mt-4 text-[0.95rem] leading-6 font-medium text-ink lg:text-[15px] lg:leading-[1.5]">
            {content.lead}
          </p>
          <p className="mt-2.5 text-[0.9rem] leading-6 text-ink lg:text-[14.5px] lg:leading-[1.55]">
            {content.copy}
          </p>
